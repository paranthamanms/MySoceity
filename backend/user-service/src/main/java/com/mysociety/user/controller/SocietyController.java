...
import com.mysociety.user.service.SocietyService;
...
public class SocietyController {
    ...
    /**
     * Generate scanner code for a society (Society Admin)
     */
    @PostMapping("/{societyName}/scanner-code/generate")
    public ResponseEntity<Map<String, Object>> generateScannerCode(
            @PathVariable String societyName,
            @RequestBody(required = false) Map<String, String> body) {
        Map<String, Object> response = new HashMap<>();
        try {
            String generatedBy = body != null ? body.get("generatedBy") : null;
            Map<String, Object> data = societyService.generateScannerCode(societyName, generatedBy);
            response.put("success", true);
            response.put("message", "Scanner code generated successfully");
    ...
    /**
     * Get scanner code for a society (Security/Society Admin)
     */
    @GetMapping("/{societyName}/scanner-code")
    public ResponseEntity<Map<String, Object>> getScannerCode(@PathVariable String societyName) {
        Map<String, Object> response = new HashMap<>();
        try {
            Map<String, Object> data = societyService.getScannerCode(societyName);
            response.put("success", true);
            response.putAll(data);
            return ResponseEntity.ok(response);
        } catch (Exception e) {
