...
public class UserProfileService {
    ...
    /**
     * Get all users in a specific society
     * Useful for user directory feature
     */
    public List<UserProfile> getUsersBySociety(String societyName) {
        return profileRepository.findBySocietyName(societyName);
    }
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < headers.length; i++) {
                        ...
                        } else if (header.equals("phonenumber") || header.equals("phone")) {
